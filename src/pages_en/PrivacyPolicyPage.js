...
const PrivacyPolicyPage = () => {
  ...
  return (
    <>
      <Navbar profilePic={user?.profilePic}></Navbar>
      <Wrapper>
        <div class="privacy">
          <h2 class="privacy__title">Privacy Policy</h2>

          <p class="privacy__paragraph">Last updated: October 21, 2021</p>
          ...
          <h2 class="privacy__title">Interpretation and Definitions</h2>

          <h2 class="privacy__subtitle">Interpretation</h2>
          ...
          <h2 class="privacy__subtitle">Definitions</h2>
          ...
          <ul class="privacy__ul">
            ...
            <li class="privacy__li">
              <p class="privacy__paragraph">
                ...
                "We", "Us" or "Our" in this Agreement) refers to Banayah,
            ...
            <li class="privacy__li">
              <p class="privacy__paragraph">
                {" "}
                <strong>Website</strong> refers to Banayah.com, accessible from
                <a href="https://www.Banayah.com/">www.Banayah.com</a>
              </p>
            </li>
            <li class="privacy__li">
              <p class="privacy__paragraph">
          ...
          <h2 class="privacy__subtitle">Types of Data Collected</h2>

          <p class="privacy__sub">Personal Data</p>
          ...
          <ul class="privacy__ul">
            <li class="privacy__li">
              <p class="privacy__paragraph"> Email address</p>
            </li>
            <li class="privacy__li">
              <p class="privacy__paragraph"> First name and last name</p>
            </li>
            <li class="privacy__li">
              <p class="privacy__paragraph"> Phone number</p>
            </li>
            <li class="privacy__li">
              <p class="privacy__paragraph">
                {" "}
            ...
            <li class="privacy__li">
              <p class="privacy__paragraph"> Usage Data</p>
            </li>
          </ul>

          <p class="privacy__sub">Usage Data</p>
          ...
          <p class="privacy__sub">Tracking Technologies and Cookies</p>
          ...
          <ul class="privacy__ul">
            ...
            <li class="privacy__li">
              <p class="privacy__paragraph">
                ...
                on how You can delete Flash Cookies, please check "Where can I
          ...
          <ul class="privacy__ul">
            <li class="privacy__li">
              ...
              <p class="privacy__paragraph">Type: Session Cookies</p>

              <p class="privacy__paragraph">Administered by: Us</p>
              <p class="privacy__paragraph">
            ...
            <li class="privacy__li">
              ...
              <p class="privacy__paragraph">Type: Persistent Cookies</p>
          ...
          <h2 class="privacy__subtitle">Use of Your Personal Data</h2>
          ...
          <h2 class="privacy__subtitle">Retention of Your Personal Data</h2>
          ...
          <h2 class="privacy__subtitle">Transfer of Your Personal Data</h2>
          ...
          <h2 class="privacy__subtitle">Disclosure of Your Personal Data</h2>

          <p class="privacy__sub">Business Transactions</p>
          ...
          <p class="privacy__sub">Law enforcement</p>
          ...
          <p class="privacy__sub">Other legal requirements</p>
          ...
          <ul class="privacy__ul">
            <li class="privacy__li">
              <p class="privacy__paragraph">Comply with a legal obligation</p>
            </li>
            <li class="privacy__li">
              <p class="privacy__paragraph">
            ...
            <li class="privacy__li">
              <p class="privacy__paragraph">Protect against legal liability</p>
            </li>
          </ul>

          <h2 class="privacy__subtitle">Security of Your Personal Data</h2>
          ...
          <h2 class="privacy__title">Links to Other Websites</h2>
          ...
          <ul class="privacy__ul">
            <li class="privacy__li">
              <p class="privacy__paragraph">By email: zubair@Banayah.com</p>
            </li>
          </ul>
        </div>
      </Wrapper>
